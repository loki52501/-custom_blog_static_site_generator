...
std::string applyTemplate(const std::string& templateContent, const std::string& title,
                          ...
                          int subdirectoryDepth, const std::string& toc, bool isBlogPost) {
    ...
    // Replace comments placeholder - only add Utterances for blog posts
        ...
        commentsSection = R"(
            ...
            <div class="comments-section">
                <script src="https://utteranc.es/client.js"
                        repo="loki52501/loki52501.github.io"
                        issue-term="pathname"
    ...
    pos = result.find("{{COMMENTS}}");
    if (pos != std::string::npos) {
        result.replace(pos, 12, commentsSection);
    }
